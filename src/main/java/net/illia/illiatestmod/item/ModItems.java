...
public class ModItems {
	public static ToolItem RUBY_SHOVEL = new ShovelItem(RubyMaterialItem.INSTANCE, -1.5F, -3.0F, new Item.Settings().group(ModItemGroups.ILLIA_TEST_MOD));
	public static ToolItem RUBY_SWORD = new SwordItem(RubyMaterialItem.INSTANCE, 3, -2.4F, new Item.Settings().group(ModItemGroups.ILLIA_TEST_MOD));
	public static ToolItem RUBY_PICKAXE = new RubyPickaxeItem(RubyMaterialItem.INSTANCE, 1, -2.8F, new Item.Settings().group(ModItemGroups.ILLIA_TEST_MOD));
	public static ToolItem RUBY_AXE = new RubyAxeItem(RubyMaterialItem.INSTANCE, 3, -2.8F, new Item.Settings().group(ModItemGroups.ILLIA_TEST_MOD));
	public static ToolItem RUBY_HOE = new RubyHoeItem(RubyMaterialItem.INSTANCE, -1, -3.0F, new Item.Settings().group(ModItemGroups.ILLIA_TEST_MOD));
	...
	public static final Item RUBY = new RubyMaterialItem(new Item.Settings().group(ModItemGroups.ILLIA_TEST_MOD));
