...
import net.illia.illiatestmod.entity.IlliaCubeEntity;
...
public class IlliaTestMod implements ModInitializer {
	...
	public void onInitialize() {
		...
		FabricDefaultAttributeRegistry.register(IlliaTestMod.ILLIA_CUBE, IlliaCubeEntity.createMobAttributes());
